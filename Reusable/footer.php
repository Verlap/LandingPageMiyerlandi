<footer>
    ...
    <div id="SocialNetwork">
        ...
        <a href="https://www.tiktok.com/discover/miyerlandi" class="social" target="_blank">
            <img
                src="Assets/SocialNetwork/TikTokLogoWhite.svg"
                alt="TikTok de Miyerlandi" />
        </a>
        <a href="https://www.youtube.com/@miyerlanditorres9904" class="social" target="_blank">
            <img
